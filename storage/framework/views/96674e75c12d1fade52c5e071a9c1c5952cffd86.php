...
<section class="service">
    <div class="service__inner container">
        ...
        <a class="service__btn btn" href="<?php echo e(route('user', ['userId' => auth()->id()])); ?>">Подать заявку</a>
        <?php endif; ?>
    </div>
</section>
<!-- /.Service -->
...
<?php /**PATH D:\tools\OSPanel\domains\groomroom-master\resources\views/home.blade.php ENDPATH**/ ?>